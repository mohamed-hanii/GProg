...
<?php
    ...
    include "header/saved_header.php";
...
?>
    ...
    <div class="container">
        ...
        <div class="middle-panel">
          ...
          <h3 style="color: green; font-family: cursive; font-size: 20px;"><i class="fa-solid fa-bookmark"></i> Saved</h3>
...
<?php
    ...
    include "loop/saved_loop.php";

?>

<?php

    include "ajax/saved_ajax.php";
