...
<nav class="navvv">
            ...
            <a style="cursor: pointer;" id="menu" class="navv menu">
...
<!-- Powerd By Mohamed Hany -->
            ...
            <a style="cursor: pointer;" id="points" class="navv ppp">

              <i class="fa-solid fa-ellipsis"></i>

            </a>
        
            <a class="profile" href="profile.php?username=<?php echo urlencode($user); ?>">
                ...
                <div style="width:40px !important;height:40px !important;border-radius: 50% !important;overflow:hidden !important;" class="prof profile">
                    ...
                    <img style="width:100% !important;cursor:pointer !important;" src="<?php echo 'uploads/' . $profile_picture; ?>" alt="">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.post-menu').forEach(function (button) {

                button.addEventListener('click', function () {

                    hideAllAndShowHideContent();

                    document.getElementById('title').innerHTML = '<i style="margin-top:30px !important;" class="fa-solid fa-bars"></i> Post Menu';
                    
                    document.getElementById('content').innerHTML = `

                        <p class="iteem"><i class="fa-solid fa-pen"></i> Edit Post</p>

                        <p class="iteem"><i class="fa-solid fa-trash"></i> Delete</p>
