...
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
    ...
    $post_sql = "SELECT * FROM posts ORDER BY RAND() LIMIT $posts_per_page OFFSET $offset";
    ...
    if (mysqli_num_rows($post_result) > 0) {
            ...
            echo '
                ...
                <div class="post-bottom">
                    ...
                    class="action post-reacts love">
                        ...
                        class="change ' . ($is_liked ? 'fa-solid' : 'fa-regular') . ' fa-heart">
        ...
        echo "No more Questions to display."; 
