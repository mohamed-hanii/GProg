        ...
        <div class="right__col">
          ...
          <nav style="  display: flex;justify-content: space-evenly; align-items: center;">
            ...
            <ul style="font-size: 12.5px;">
              ...
              <li><a><i class="fa-solid fa-clock-rotate-left"></i> All Questions & Problems</a></li>
              
              <li><a href="about-profile.php?username=<?php echo urlencode($user['username']); ?>"><i class="fa-solid fa-address-card"></i> About</a></li>
             
              <li><a href="inbox.php?username=<?= $user['username'] ?>"><i class="fa-solid fa-comments"></i> Send Message</a></li>
...
if (mysqli_num_rows($post_result) > 0) {
  ...
  while ($post = mysqli_fetch_assoc($post_result)) {
    ...
    $post_check_like_sql = "SELECT * FROM post_like WHERE post_id = '" . $post['id'] . "' AND user_id = '" . $user_idd . "'";
   
    $post_check_like_result = mysqli_query($conn, $post_check_like_sql);
   
    $is_liked = mysqli_num_rows($post_check_like_result) > 0;

    $post_check_saved_sql = "SELECT * FROM saved WHERE post_id = '" . $post['id'] . "' AND user_id = '" . $user_idd . "'";
