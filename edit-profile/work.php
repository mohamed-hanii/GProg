...
<?php
	...
	include "../update/update_work.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-briefcase"></i> Work</h1>
		...
		<div class="row mt-5 pt-5 ">
			...
			<p class="mt-5 pt-5">Work Title :</p><br>

			<input class="email" name="work_title" value="<?= $user['work_title'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5">Work Place :</p><br>
			
			<input class="email" name="work_place" value="<?= $user['work_place'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5">Work Website :</p><br>
           
		    <input class="email" name="work_web" value="<?= $user['work_web'] ?>" type="text"><br><br><br>
