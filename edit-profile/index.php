...
<?php
	...
	include "../update/update_login_data.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-gear"></i> Account Settings</h1>
		...
		<div class="card w-75 mb-3" style="border: 1px solid black;">
		  ...
		  <?php if (!empty($alert_message)): ?>
			...
			<div class="alert alert-<?php
				...
				if ($alert_message === "updated successfully!") {
		...
		<div class="row mt-5 pt-5 ">
			...
			<p class="mt-5 pt-5">Email Address :</p><br>

			<input class="email" name="email" value="<?= $user['email'] ?>" type="email"><br><br><br><br><br><br>
			
			<p class="mt-5 pt-5">UserName :</p><br>
			
			<input class="email" name="username" value="<?= $user['username'] ?>" type="text"><br><br><br>
			
			<br>
			
			<p>Note: After Changing Your Username, You Will Logged out of your GProg account.</p>
