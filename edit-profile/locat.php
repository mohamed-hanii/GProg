...
<?php
	...
	include "../update/update_locat.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-location-dot"></i> Location</h1>
		...
		<div class="row mt-5 pt-5 ">
			...
			<p class="mt-5 pt-5">Your Country :</p><br>

			<input class="email" name="country" value="<?= $user['country'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5">Your City :</p><br>
			
			<input class="email" name="city" value="<?= $user['city'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5">Your Town :</p><br>
			
			<input class="email" name="town" value="<?= $user['town'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5">Your Address :</p><br>
			
			<input class="email" name="address" value="<?= $user['address'] ?>" type="text"><br><br><br>
		
			<p class="mt-5 pt-5">Post Code :</p><br>
           
		    <input class="email" name="post_code" value="<?= $user['post_code'] ?>" type="text"><br><br><br>
