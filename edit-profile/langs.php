...
<?php
	...
	include "../update/update_langs.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-globe"></i> Languages</h1>
		...
		<div class="row mt-5 pt-5 ">
			...
			<p class="mt-5 pt-5">Spoken Languages :</p>
			
			<br>

			<input class="email" name="spoken_langs" value="<?= $user['spoken_langs'] ?>" type="text"><br>
			
			<p>Write between them (,) like this: English, French, German,</p><br>
			
			<br>  <br>
			
			<p class="mt-5 pt-5">Programming Languages :</p><br>
			
			<input class="email" name="prog_langs" value="<?= $user['prog_langs'] ?>" type="text"><br>
			
			<p class="mt-5 pt-5">Write between them (,) like this: Python, html, javascript,</p><br>
