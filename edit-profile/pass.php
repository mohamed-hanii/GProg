...
<?php
	...
	include "../update/update_pass.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-lock"></i> Password</h1>
		...
		<?php if (!empty($alert_message)): ?>
			...
			if ($alert_message === "Password updated successfully!") {
		...
		<form action="pass.php" method="POST">
			...
			<div class="row mt-5 pt-5 ">
				...
				<p class="mt-5 pt-5"> <?= $user['security_ask'] ?> :</p><br>

				<input class="email" name="answer" placeholder="Your Answer" type="text"><br>

				<br>

				<p class="mt-5 pt-5">New Password :</p><br>
				
				<input class="email" name="new_password" placeholder="New Password" type="password"><br><br><br>

				<p class="mt-5 pt-5">Confirm New Password :</p><br>
				
				<input class="email" name="confirm_password" placeholder="Confirm New Password" type="password"><br><br><br>
