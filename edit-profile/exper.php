...
<?php
	...
	include "../update/update_exper.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-earth-europe"></i> Experiences</h1>
		...
		<form action="exper.php" method="POST">

		<div class="row mt-5 pt-5 ">

			<p class="mt-5 pt-5">Your area of ​​expertise :</p><br>

			<input class="email" name="exper_area" value="<?= $user['exper_area'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5">Your previous works :</p><br>
			
			<input class="email" name="exper_work" value="<?= $user['exper_work'] ?>" type="text"><br><br><br>
