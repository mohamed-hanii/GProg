...
<?php
	...
	include "../update/update_links.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-hashtag"></i> Social Links</h1>
		...
		<div class="row mt-5 pt-5 ">
			...
			<p class="mt-5 pt-5"><i class="fa-brands fa-instagram"></i> Instagram :</p><br>
			
			<input class="email" name="insta" value="<?= $user['insta'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5"><i class="fa-brands fa-facebook"></i> Facebook :</p><br>
			
			<input class="email" name="facebook" value="<?= $user['facebook'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5"><i class="fa-brands fa-github"></i> Github :</p><br>
			
			<input class="email" name="github" value="<?= $user['github'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5"><i class="fa-brands fa-linkedin"></i> Linkedin :</p><br>
			
			<input class="email" name="linkedin" value="<?= $user['linkedin'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5"><i class="fa-brands fa-twitter"></i> Twitter :</p><br>
			
			<input class="email" name="twitter" value="<?= $user['twitter'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5"><i class="fa-brands fa-vk"></i> Vkontakte :</p><br>
			
			<input class="email" name="vk" value="<?= $user['vk'] ?>" type="text"><br><br><br>
			
			<p class="mt-5 pt-5"><i class="fa-brands fa-youtube"></i> YouTube :</p><br>
			
			<input class="email" name="youtube" value="<?= $user['youtube'] ?>" type="text"><br><br><br>
