...
<?php
	...
	include "../update/update_field.php";
	...
	<div class="col-sm-9 text-center col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h3 class="page-header"><i class="fa-solid fa-laptop-code"></i> Field</h1>
		...
		<div class="row mt-5 pt-5 ">
			...
			<p class="mt-5 pt-5">Your Field :</p><br>

			<select name="field" required style="border-radius: 0;" class="form-select texts" id="inputGroupSelect02">
		
		<?php

            foreach ($field_user as $field) {

				$selected = ($current_field == $field['id']) ? 'selected' : ''; 
